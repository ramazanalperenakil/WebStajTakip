<%@ Page Title="" Language="C#" MasterPageFile="~/ana.master" AutoEventWireup="true" CodeFile="KurumMenuStajyerDetay.aspx.cs" Inherits="KurumMenuStajyerDetay" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1>Kurum Menü Stajyer Detay Görüntüleme Sayfası</h1>
      <div class="container">
        <div class="row">
